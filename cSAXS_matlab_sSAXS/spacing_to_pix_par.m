%[ pix ] = spacing_to_pix_par( spacing_nm, par )
...
function [ pix ] = spacing_to_pix_par( spacing_nm, par )

pix = atan( asin(par.lambda_A*0.1 / 2 / spacing_nm) * 2 ) / par.pix_size * par.det_dist;
